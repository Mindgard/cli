...
# def submit_test_progress(progress:Progress, access_token:str, model_name:str) -> Dict[str,Any]:
#     with progress:
...
# def submit_test_fetching_initial(access_token:str, model_name:str) -> Dict[str, Any]:
#     initial_resp = self._api.submit_test(access_token, model_name)
#     return self._api.get_test(access_token, initial_resp["id"])
    
# def run_inner(access_token:str, model_name:str, json_format:bool, risk_threshold:int) -> CliResponse:
#     if json_format:
...
# @require_auth
# def run(access_token:str, model_name:str, json_format:bool, risk_threshold:int) -> CliResponse:
#     """
#     Run the command.
...
# def run_json(access_token:str, model_name:str, risk_threshold:int) -> CliResponse:
...
# def calculate_exit_code(test_res:Dict[str, Any], risk_threshold:int) -> int:
